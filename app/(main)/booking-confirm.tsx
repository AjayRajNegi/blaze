					...
					<View className="p-5">
						...
						<View className="flex-row mt-4">
							{[
								...
								>
									<Text className="text-white text-xs px-2 py-1.5 mx-1 font-semibold">
										{s}
									</Text>
								</View>
							))}
				...
				<View className="flex-row items-center justify-between mb-4">
					...
					<View className="items-end">
						...
						<Text className="text-white font-semibold text-lg">
							{totalDays} day{totalDays > 1 ? "s" : ""} • {totalHours} hr
						</Text>
					</View>
				</View>
...
const steps = ["Select Car", "Review", "Confirm"];
		...
		<View className="flex-row items-center px-6 mb-4">
			{steps.map((step, i) => (
				<React.Fragment key={step}>
					<View className="flex-row items-center">
						<View
							className={`${step === "Confirm" ? "w-8 h-8 rounded-full items-center justify-center bg-[#00D4AA]" : "w-8 h-8 rounded-full items-center justify-center bg-[#e8500a]"}`}
						>
							<Text className="text-white text-xs font-bold">{i + 1}</Text>
						</View>
						<Text
							className={`${step === "Confirm" ? "text-[#00D4AA] text-xs font-semibold ml-2" : "text-[#e8500a] text-xs font-semibold ml-2"}`}
						>
							{step}
						</Text>
					</View>
					...
					{i < steps.length - 1 && (
						<View className="flex-1 h-px mx-2 bg-[#e8500a]" />
					)}
				</React.Fragment>
			))}
		</View>
