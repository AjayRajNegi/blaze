	...
	return (
		<SafeAreaView className="flex-1 bg-[#0A0A0F] ">
			<View className="flex-row items-center px-6 pt-4 pb-4">
				<TouchableOpacity
					onPress={() => router.back()}
					className="w-10 h-10 mr-2 rounded-2xl bg-[#13131A] border border-[#22222E] items-center justify-center"
				>
			...
			<View className="mx-6 mb-4 bg-[#13131A] border border-[#22222E] rounded-2xl py-3 px-4 flex-row items-center justify-between">
				...
				<View className="w-px h-4 bg-[#22222E]" />
				<View className="bg-[#E8500A] rounded-full px-2 py-1">
					<Text className="bg-[#E8500A] text-white text-xs font-bold">
